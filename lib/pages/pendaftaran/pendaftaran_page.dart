              ...
              _KartuEdukasi(
                ...
                items: const [
                  _ItemEdukasi(
                    ...
                    judul: 'Aman dan Terkontrol',
                    deskripsi: 'Proses donor darah dilakukan oleh tenaga medis terlatih dengan peralatan steril sekali pakai.',
                  ),
                  _ItemEdukasi(
                    iconAsset: 'assets/icons/edukasi/syarat.png',
                    judul: 'Syarat Kesehatan',
                    deskripsi: 'Pendonor harus memenuhi syarat kesehatan seperti berat badan minimal 45 kg dan kondisi fisik sehat.',
                  ),
                  _ItemEdukasi(
                    iconAsset: 'assets/icons/edukasi/rutin.png',
                    judul: 'Donor Rutin',
                    deskripsi: 'Donor darah dapat dilakukan setiap 3 bulan sekali untuk pria dan 4 bulan sekali untuk wanita.',
                  ),
                ],
              ),
              const SizedBox(height: 16),
              ...
              _KartuEdukasi(
                ...
                items: const [
                  _ItemEdukasi(
                    ...
                    deskripsi: 'Donor darah secara rutin dapat membantu mengurangi risiko penyakit jantung dan stroke.',
                  ),
                  _ItemEdukasi(
                    iconAsset: 'assets/icons/edukasi/deteksi.png',
                    judul: 'Deteksi Penyakit Dini',
                    deskripsi: 'Sebelum donor, darah Anda akan diperiksa sehingga dapat mendeteksi penyakit lebih awal.',
                  ),
                  _ItemEdukasi(
                    iconAsset: 'assets/icons/edukasi/produksi.png',
                    judul: 'Merangsang Produksi Sel Darah',
                    deskripsi: 'Donor darah merangsang tubuh untuk memproduksi sel darah merah baru yang lebih segar.',
                  ),
                ],
              ),
            ],
